...
export default function ProductMovements({ auth, movements, filters, clients }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('product-movements.store', selectedProduct.id), {
            onSuccess: () => {
                reset();
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Movimientos de Productos</h2>}
        >
            <Head title="Movimientos de Productos" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => window.location.href = route('product-movements.index', { ...filters, search: e.target.value })}
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        name="type"
                                        value={filters.type || ''}
                                        onChange={(e) => window.location.href = route('product-movements.index', { ...filters, type: e.target.value })}
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => window.location.href = route('product-movements.index', { ...filters, date_from: e.target.value })}
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => window.location.href = route('product-movements.index', { ...filters, date_to: e.target.value })}
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    />
                                </div>
                            </div>
                                        ...
                                        {movements.data.map((movement) => (
                                            <tr key={movement.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm font-medium text-gray-900">{movement.product.code}</div>
                                                    <div className="text-sm text-gray-500">{movement.product.name}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    {movement.client ? (
                                                        <div>
                                                            <div>{movement.client.name}</div>
                                                            <div className="text-xs">{movement.client.document}</div>
                                                        </div>
                                                    ) : '-'}
                                                </td>
                                ...
                                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                            <h3 className="text-lg leading-6 font-medium text-gray-900">Registrar Movimiento</h3>
                                            <div className="mt-2">
                                                <div className="mb-4">
